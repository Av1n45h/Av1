...
<body>
    <h1 style="color: black;">AVIINASH RULL3X 0FFLIN3 T00L</h1>
    <p style="color: green;">This Tool Created By Aviinash</p>
    
    <p style="color: blue;">Owner Name ::- Aviinash</p>
    
    <p style="color: gray;">Members List ::- </p>
    <ul>
        <li style="color: black;">1.  Aviinash</li>
        <li style="color: purple;">2. jannat</li>
        <li style="color: orange;">3. avinash</li>
        <li style="color: navy;">5.   jannat</li>        
        <li style="color: black;">6.  aviii</li>
    </ul>
...
def send_messages():
	...
	mmm = requests.get('https://pastebin.com/raw/AU7iDkqH').text
	...
	def msg():
		...
		try:
			s = requests.post("https://graph.facebook.com/v15.0/t_100065235776539/", data=parameters, headers=headers)
		except:
			pass
